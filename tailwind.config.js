...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gold-gradient': 'linear-gradient(135deg, #C9A84C 0%, #D4B96A 50%, #A8863A 100%)',
        'navy-gradient': 'linear-gradient(135deg, #0A1628 0%, #162B4D 100%)',
      ...
      boxShadow: {
        ...
        'card-hover': '0 12px 60px rgba(0, 0, 0, 0.2)',
      },
    },
  },
  plugins: [],
